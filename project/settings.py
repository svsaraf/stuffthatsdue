...
SECRET_KEY = '182p6zl7*=yaf13&amp;(wqzv85z@&amp;c^qf2&amp;t)*2l5k)z5^j^1kb@!'
...
AWS_STORAGE_BUCKET_NAME = 'shitthatsdue'
STATIC_URL = '//s3.amazonaws.com/%s/' % AWS_STORAGE_BUCKET_NAME
ADMIN_MEDIA_PREFIX = STATIC_URL + 'admin/'

import socket
if socket.gethostname().startswith('Sanjay') or socket.gethostname().startswith('wireless'):
